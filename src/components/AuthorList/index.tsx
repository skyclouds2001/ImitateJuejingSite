      ...
      <div className={styles.authorList}>
        ...
        <article className={styles.authorContent}>
          <section className={styles.authorItem}>
            <img className={styles.authorAvatar} src="https://p3-passport.byteimg.com/img/user-avatar/ee5b3d33c959244bf7b70b28bb3a4d07~100x100.awebp" alt={'' /* todo */} loading="lazy" title="用户头像" />
